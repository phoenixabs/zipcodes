...
function cachedGetter(obj, name, fn) {
...
cachedGetter(exports, 'states', () => require('./states'));
cachedGetter(exports, 'codesUS', () => require('./codes'));
cachedGetter(exports, 'codesCanada', () => require('./codesCanada'));
cachedGetter(exports, 'stateMap', () => Object.assign({}, exports.codesUS.stateMap, exports.codesCanada.stateMap));
cachedGetter(exports, 'codes', () => Object.assign({}, exports.codesUS.codes, exports.codesCanada.codes));



var lookup = function(zip) {
    if (zip != null && zip != undefined && typeof zip === "string" && isNaN(zip.charAt(0))) {
      return exports.codes[zip.slice(0, 3)];
    }
    return exports.codes[zip];
};
...
var byState = function(state) {
    var normalized = exports.states.normalize(state.toUpperCase()),
        ret = [],
        mapping = exports.stateMap[normalized] || exports.stateMap[state];
...
function buildGeohashLookup() {
    ...
    for (var i in exports.codes) {
        var code = exports.codes[i];
...
function lookupByCoords(lat,lon) {				// Return the closest code to coordinates at lat,lon
	...
	for(zip in exports.codes) {
		var code = exports.codes[zip];
